...
class TestFields(unittest.TestCase):
    def setUp(self):
        ...
        self.a2 = Fq2((self.a1, self.b1), self.a1.q)
        self.b2 = Fq2((self.b1, self.c1), self.a1.q)
        self.c2 = Fq2((self.c1, self.d1), self.a1.q)
        self.d2 = Fq2((self.d1, self.e1), self.a1.q)
        self.e2 = Fq2((self.e1, self.f1), self.a1.q)
        self.f2 = Fq2((self.f1, self.g1), self.a1.q)

        self.a6 = Fq6((*self.a2, *self.b2, *self.c2), self.a2.q)
        self.b6 = Fq6((*self.b2, *self.c2, *self.d2), self.a2.q)
        self.c6 = Fq6((*self.d2, *self.e2, *self.f2), self.a2.q)

        self.a12 = Fq12((*self.a6, *self.b6), self.a6.q)
        self.b12 = Fq12((*self.b6, *self.c6), self.a6.q)
    ...
    def test_Fq2(self):
        ...
        self.assertTrue(self.a2 - self.a2 == 0)
        self.assertTrue((self.a2 * self.b2 / self.b2 / self.a2) == 1)
    ...
    def test_Fq6(self):
        ...
        self.assertTrue((self.a6 - self.a6) == 0)
        self.assertTrue((self.a6 * self.b6 / self.b6 / self.a6) == 1)
        self.assertEqual(self.a6 ** 3, self.a6 * self.a6 * self.a6)

    def test_Fq12(self):
        self.assertEqual(self.a12 + self.a12, self.a12 * 2)
        self.assertTrue((self.a12 - self.a12) == 0)
        self.assertTrue((self.a12 * self.b12 / self.b12 / self.a12) == 1)
        self.assertEqual(self.a12 ** 3, self.a12 * self.a12 * self.a12)


class TestParams(unittest.TestCase):
    def test_frobenius_coefficients(self):
        all_one_poly = Fq2((1, 1), q)
